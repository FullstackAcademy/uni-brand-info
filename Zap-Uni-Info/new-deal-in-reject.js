...
if (brand === 'CPU') {
  advisorLink = 'https://start.fullstackacademy.com/meetings/fsa/cpextended-ed'
  ...
  advisorLink = 'https://start.fullstackacademy.com/meetings/fsa/unf-bootcamps'
  ...
  advisorLink = 'https://start.fullstackacademy.com/meetings/fsa/usd-bootcamps'
  ...
  advisorLink = 'https://start.fullstackacademy.com/meetings/fsa/lsu-bootcamps'
  ...
  advisorLink = 'https://start.fullstackacademy.com/meetings/fsa/caltech-bootcamps'
  ...
  advisorLink = 'https://start.fullstackacademy.com/meetings/fsa/oku-bootcamps'
  ...
  advisorLink = 'https://start.fullstackacademy.com/meetings/fsa/vt-bootcamps'
  ...
  advisorLink = 'https://start.fullstackacademy.com/meetings/fsa/ece-bootcamps'
  ...
  advisorLink = 'https://start.fullstackacademy.com/meetings/fsa/uic-bootcamps'
  ...
  advisorLink = 'https://start.fullstackacademy.com/meetings/fsa/sjsu-bootcamps'
  ...
  advisorLink = 'https://start.fullstackacademy.com/meetings/fsa/csu-bootcamps'
  ...
  advisorLink = 'https://start.fullstackacademy.com/meetings/fsa/cse-bootcamps'
  ...
  advisorLink = 'https://start.fullstackacademy.com/meetings/fsa/cle-bootcamps'
  ...
  advisorLink = 'https://start.fullstackacademy.com/meetings/fsa/university-of-texas-at-dallas-tech-bootcamps'
  ...
  advisorLink = 'https://start.fullstackacademy.com/meetings/fsa/osu-bootcamps'
  if (curriculum === 'DAT') programName = 'OSU Data Analytics Bootcamp'
  else throw new Error('Invalid Curriculum: OSU')
} else if (brand === 'UNM') {
  advisorLink = 'https://start.fullstackacademy.com/meetings/fsa/unm-bootcamps'
  ...
  advisorLink = 'https://start.fullstackacademy.com/meetings/fsa/usu-bootcamps'
